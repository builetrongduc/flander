...
from .models import CifarNet, MnistNet, test_cifar, test_mnist, train_cifar, train_mnist, MobileNet, train_mobilenet, test_mobilenet, test_fmnist, train_fmnist, FMnistNet
...
class CifarClient(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        grad = train_cifar(self.net, trainloader, epochs=config["epochs"], device=self.device)

        return (
            get_params(self.net),
            len(trainloader.dataset),
            {"cid": self.cid, "grad": grad},
        )
...
class Cifar100Client(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        self.net.to(self.device)
        grad = train_mobilenet(self.net, trainloader, epochs=config["epochs"], device=self.device)
...
class MnistClient(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        self.net.to(self.device)
        grad = train_mnist(self.net, trainloader, epochs=config["epochs"], device=self.device)
...
class FMnistClient(fl.client.NumPyClient):
    ...
    def fit(self, parameters, config):
        ...
        self.net.to(self.device)
        grad = train_fmnist(self.net, trainloader, epochs=config["epochs"], device=self.device)
